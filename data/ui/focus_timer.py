...
class FocusTimerApp(ctk.CTkToplevel):
    ...
    def build_stopwatch(self):
        ...
        btn_frame.pack()
        self.sw_start_btn = ctk.CTkButton(
            btn_frame, text="Start", width=80, command=self.sw_start
        )
        self.sw_start_btn.pack(side="left", padx=5)
        ctk.CTkButton(btn_frame, text="Pause", width=80, command=self.sw_pause).pack(
            side="left", padx=5
        )
        ctk.CTkButton(
            btn_frame,
    ...
    def build_timer(self):
        ...
        self.t_hr = ctk.CTkEntry(
            input_frame, width=50, placeholder_text="00", justify="center"
        )
        self.t_min = ctk.CTkEntry(
            input_frame, width=50, placeholder_text="00", justify="center"
        )
        self.t_sec = ctk.CTkEntry(
            input_frame, width=50, placeholder_text="00", justify="center"
        )
        ...
        self.timer_label = ctk.CTkLabel(
            tab, text="00:00:00", font=("Arial", 50, "bold")
        )
        self.timer_label.pack(pady=20)
        btn_frame = ctk.CTkFrame(tab, fg_color="transparent")
        btn_frame.pack()
        self.timer_start_btn = ctk.CTkButton(
            btn_frame, text="Start", width=80, command=self.timer_start
        )
        self.timer_start_btn.pack(side="left", padx=5)
        ctk.CTkButton(btn_frame, text="Pause", width=80, command=self.timer_pause).pack(
            side="left", padx=5
        )
        ctk.CTkButton(
            btn_frame,
    ...
    def build_alarm(self):
        ...
        self.alarm_status = ctk.CTkLabel(
            tab, text="NO ALARM SET", font=("Arial", 14), text_color="gray"
        )
    ...
    def set_alarm(self):
        ...
        self.alarm_status.configure(
            text=f"ALARM SET FOR {display_time }", text_color="#2CC985"
        )
